...
type ProjectFormInput = z.input<typeof formSchema>;
type ProjectFormOutput = z.output<typeof formSchema>;
...
const ProjectForm = () => {
  ...
  const form = useForm<ProjectFormInput, undefined, ProjectFormOutput>({
